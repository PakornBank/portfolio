    ...
    <div className="about">
      ...
      <ul className="text">
        <li>
          <h2>What can I do?</h2>
          <p>
            I have experience building single page web with HTML, CSS, MongoDB,
            Express, React and Node.js, commonly known as the MERN tech stack. I
            also have proficiency in C, C++, and Arduino, and also a fundamental
